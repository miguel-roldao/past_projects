...
gchar *cssData = "@define-color color1 #ab0567;\n"
                 ...
                 "label.label_Main {color: @color1;font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
                 ...
                 "GtkLabel.label_Main {color: @color1;font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
