...
gchar *cssData = "window {background-color: Wheat1;}\n"
                 "label#label1 {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
...
#else
gchar *cssData = "GtkWindow {background-color: Wheat1;}\n"
                 "GtkLabel#label1 {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
...
main (int argc, char **argv)
{
  ...
  gtk_widget_set_name (GTK_WIDGET(bminus), "btminus");
  ...
  gtk_widget_set_name (GTK_WIDGET(bplus), "btplus");
