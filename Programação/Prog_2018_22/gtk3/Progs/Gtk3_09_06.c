...
gchar *cssData = "window {background-color: Wheat1;}\n"
                 "label.label_Main {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
...
gchar *cssData = "GtkWindow {background-color: Wheat1;}\n"
                 "GtkLabel.label_Main {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
